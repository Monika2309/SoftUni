    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i <n ; i++) {
            for (int j = 0; j < n; j++) {
                ...
                if (matrix[i][j]=='P' && !foundFirst){
                    firstRow=i;
                    firstCol=j;
                    foundFirst=true;
                }else if (matrix[i][j]=='P' && foundFirst){
                    secondRow=i;
                    secondCol=j;
                }
            }
        ...
        while (money<50){
            ...
            if (isInBounds(matrix,myRow,myCol)){
                if (myRow==firstRow&&myCol==firstCol && matrix[myRow][myCol]=='P'){
                    matrix[myRow][myCol]='-';
                    myRow=secondRow;
                    myCol=secondCol;
                }else if (myRow==secondRow && myCol==secondCol && matrix[myRow][myCol]=='P'){
                    matrix[myRow][myCol]='-';
                    myRow=firstRow;
                    myCol=firstCol;
